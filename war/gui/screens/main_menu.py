...
class MainMenu:
    ...
    def render(self):
        ...
        for num_players, button_rect in self.player_buttons.items():
            ...
            pygame.draw.rect(self.screen, border_color, button_rect, border_width, border_radius=8)
            
            # Texto do botão
            text_surface = self.font_medium.render(str(num_players), True, text_color)
